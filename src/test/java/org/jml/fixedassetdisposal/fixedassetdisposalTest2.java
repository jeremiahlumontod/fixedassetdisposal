...
public class fixedassetdisposalTest2 {
    ...
    public void runTest2() throws Exception {
        ...
        //get the next task to do. there will be one task if no parallel task
        ...
        do {
            ...
            taskService.complete(taskID, verifyYNflag(task));
    ...
    public int getRandom() {
    	...
    	//int  n = 5;
    	System.out.println("random decision is: " + n);
    	return n;
    }
